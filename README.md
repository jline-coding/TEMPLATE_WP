...
> [!NOTE]
> 🔧 = **初回のみ** — マシンに未インストールの場合のみ実施。既に導入済みならスキップ可能。
...
**🔧 初回のみ: Laragon のインストール**
- https://laragon.org/ からダウンロード・インストール。
- Node.js (https://nodejs.org/) と Git (https://git-scm.com/) もインストール。
...
**🔧 初回のみ: XAMPP のインストール**
- https://www.apachefriends.org/ からダウンロード・インストール。
- Node.js (https://nodejs.org/) と Git (https://git-scm.com/) もインストール。
...
> [!NOTE]
> 🔧 = **Chỉ làm 1 lần** — Khi máy chưa cài phần mềm. Đã có rồi thì bỏ qua.
> 📁 = **Mỗi project** — Làm lại mỗi khi tạo project mới.
...
#### 🔧 A. Cài đặt phần mềm cần thiết (chỉ làm 1 lần)
...
**🔧 B-1. Cài đặt MAMP (chỉ làm 1 lần)**
...
**📁 B-2. Setup template (mỗi project)**
```bash
git clone https://github.com/jline-coding/TEMPLATE_WP my-project
cd my-project
npm install
...
**📁 B-4. Cài đặt WordPress (mỗi project)**
...
**🔧 Cài đặt phần mềm (chỉ làm 1 lần):**
```bash
...
#### 🔧 B. Cấu hình Apache (chỉ làm 1 lần)
...
#### 🔧 C. Cấu hình MySQL (chỉ làm 1 lần)
...
#### 📁 E. Cài đặt WordPress (mỗi project)
...
> [!NOTE]
> 🔧 = **One-time only** — Only needed when the machine doesn’t have the software yet. Skip if already installed.
> 📁 = **Every project** — Repeat these steps for each new project.
...
**🔧 B-1. Install MAMP (one-time only)**
...
**📁 B-2. Set up the template (every project)**
```bash
git clone https://github.com/jline-coding/TEMPLATE_WP my-project
cd my-project
npm install
...
**📁 B-3. Create a Database (every project)**
...
**📁 B-4. Install WordPress (every project)**
...
**📁 Set up the template (every project):**
```bash
git clone https://github.com/jline-coding/TEMPLATE_WP my-project
cd my-project
npm install
...
#### 🔧 B. Configure Apache (one-time only)
...
#### 🔧 C. Configure MySQL (one-time only)
...
#### 📁 D. Set up the template (every project)
...
#### 📁 E. Install WordPress (every project)
