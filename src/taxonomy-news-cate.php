        ...
        <div class="l-container">
            ...
            <div class="c-list03">
                ...
                <div class="c-list03__item" data-aos="fade-up">
                    <a href="<?php echo esc_url(home_url('/news/category/'.$term->slug.'/')); ?>" class="c-btn01 c-btn01--mh60 <?php echo ($is_term->term_id == $term->term_id) ? "active" : ""; ?>"><?php echo esc_html($term->name); ?></a>
                </div>
                <?php endforeach; ?>
            </div>
            <?php endif; ?>
