...
## 自動返信メールの差出人名
$config{'fromname'} = '*company name';

## 自動返信メールの差出人メールアドレス
$config{'mailfrom'} = 'kensyo@j-line.co.jp';
...
## 設置者に届くメールの件名
$config{'subject'} = '【自動送信】お問い合わせフォームよりお問い合わせがありました';
...
$config{"ReturnSubject"} = '【自動返信】お問い合わせを受け付けました｜*company name';
