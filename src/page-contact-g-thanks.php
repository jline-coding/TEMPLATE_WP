<?php 
/* Template Name: Thanks Contact G */
get_header();
?>
<!-- ↓↓ main ↓↓ -->
<main class="p-thanks">
    <section class="c-mv c-mv01">
        <ul class="c-bread">
            ...
            <li class="c-bread__item">お問い合わせ（個人）</li>
            <li class="c-bread__item">送信完了</li>
        </ul>
    ...
    <div class="p-thanks__main">
        <div class="l-container">
            <div class="p-thanks__inner">
                <h2 class="c-ttl28" data-aos="fade-up">お問い合わせいただきましてありがとうございます。</h2>
                <p data-aos="fade-up">
                    この度は、近畿トータルサービス株式会社 公式ホームページへお問い合わせいただき誠にありがとうございます。<br>
