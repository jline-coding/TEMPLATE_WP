$config{'about'} = 'MailformPro 4.3.5 - 2026/01/03';
...
## フォームの宛先
push @mailto,'kensyo@j-line.co.jp';
...
## 自動返信メールの差出人名
$config{'fromname'} = 'CHEQAR';

## 自動返信メールの差出人メールアドレス
$config{'mailfrom'} = $mailto[0];

## 自動返信メールのreply-to
$config{'replyto'} = 'kensyo@j-line.co.jp';
...
$config{"ReturnSubject"} = '【CHEQAR】お問い合わせ受付完了｜株式会社J-LINE';
...
株式会社J-LINE
Webサイト公開前チェックサービス「CHEQAR」

URL: https://web.j-line.co.jp/
　
———————————————————————
__return_body__
...
## 受付終了日時
#$config{'CloseDate'} = '2025-08-09 00:00:00';
...
## AI機能 ChatGPT or Deepseek 機能 [New 4.3.5]
#push @Modules,'ChatGPT';
#push @Modules,'Deepseek';
