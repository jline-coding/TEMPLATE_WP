...
final class CSMF_I18n {
	...
	public static function strings( $language = '' ) {
		...
		$ja = array(
			...
			'tab_recipients' => '送信先の条件分岐', 'tab_uploads' => 'ファイル・画像添付', 'tab_diagnostics' => '診断',
		...
		$vi = array(
			...
			'page_description' => 'Quản lý kiểm tra thời gian thực, điều kiện trường nhập liệu, định tuyến người nhận và tệp/ảnh đính kèm theo từng biểu mẫu.',
			...
			'tab_recipients' => 'Điều kiện người nhận', 'tab_uploads' => 'Tệp & Ảnh đính kèm', 'tab_diagnostics' => 'Chẩn đoán',
